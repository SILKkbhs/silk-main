      ...
      <div className="w-[380px] sm:w-[460px] relative select-none overflow-visible">
        ...
        >
          ...
          <g transform="translate(179 252) scale(0.92) translate(-179 -252)">
            <path
              d="M296 28c-34-19-75-31-118-15-33 12-114 58-174 111-27 24-62 56 18 75 72 17 187 31 14 127-191 106-52 184 152 264 43 16 122 0 108-36-14-36-238-111-161-195 50-54 118-92 143-108 11-7 29-12 29-20 1-20-62-41-102-63-108-58 57-95 95-140 36-22"
              fill="url(#silkGrad)"
            />
          </g>
        </svg>
